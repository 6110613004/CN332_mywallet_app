...
struct activity: View {
    ...
    var body: some View {
            ...
            VStack{
                HStack{
                    Image(list.get_catagory())
                        ...
                        .background(list.get_type() == "green" ? Color(#colorLiteral(red: 0, green: 0.9499829412, blue: 0, alpha: 0.5)) : Color(#colorLiteral(red: 1, green: 0.4595823884, blue: 0.5358412862, alpha: 0.5)))
                        .cornerRadius(10)
                    VStack(alignment:.leading){
                        ...
                        Text("\(num_formatter.string(from: NSNumber(value: list.get_amount()))!) \(Userwallet.get_currency())")
                            ...
                            .padding(5)
                            .background(list.get_type() == "green" ? Color(#colorLiteral(red: 0, green: 0.9499829412, blue: 0, alpha: 0.5)) : Color(#colorLiteral(red: 0.8603977561, green: 0.0507125631, blue: 0.1055282578, alpha: 0.5)))
                            .cornerRadius(10)
                    }
                    Spacer()
                    Button(action:{
                ...
                VStack(alignment:.leading){
                    ...
                    HStack{
                        ...
                        if list.get_paymethod() == "รับเงินสด"{
                            Image("moneygain")
                                .resizable()
                                .renderingMode(.original)
                                .aspectRatio(contentMode: .fit)
                        ...
                        if list.get_paymethod() == "รับเข้าธนาคาร"{
                            Image("credit-card-2")
                                .resizable()
                                .renderingMode(.original)
                                .aspectRatio(contentMode: .fit)
        ...
        if list.get_special() == "รายรับค้างรับ"{
            VStack{
                HStack{
                    Image(list.get_catagory())
                        .resizable()
                        ...
                        .aspectRatio(contentMode: .fit)
                        .frame(width:60,height: 60)
                        .background(Color(#colorLiteral(red: 0, green: 0.9499829412, blue: 0, alpha: 0.5)))
                        .cornerRadius(10)
                    VStack(alignment:.leading){
                        Text("\(list.catagory)")
                            .font(.title)
...
struct activity_Previews: PreviewProvider {
    static var previews: some View {
        activity(list: Aactivaty(Date(),"test","test",100,"",Cash(),"",nil)).environmentObject(Userwallet())
    }
}
