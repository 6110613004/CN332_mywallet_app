...
struct income_expenseView: View {
...
struct income_expenseView_Previews: PreviewProvider {
    static var previews: some View {
        income_expenseView(list: Aactivaty(Date(),"test","test",100,"",Cash(),"",nil)).environmentObject(Userwallet())
    }
}
